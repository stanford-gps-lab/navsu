...
drsun = -3d0.*dhi.*sinphi.*cosphi.*fac2sun.*xsun(3).*(xsun(1).*sinla-xsun(2).*cosla)./rsun.^2;

drmon = -3d0.*dhi.*sinphi.*cosphi.*fac2mon.*xmon(3).*(xmon(1).*sinla-xmon(2).*cosla)./rmon.^2;

dnsun = -3d0.*dli.*cos2phi.*fac2sun.*xsun(3).*(xsun(1).*sinla-xsun(2).*cosla)./rsun.^2;

dnmon = -3d0.*dli.*cos2phi.*fac2mon.*xmon(3).*(xmon(1).*sinla-xmon(2).*cosla)./rmon.^2;

desun = -3d0.*dli.*sinphi.*fac2sun.*xsun(3).*(xsun(1).*cosla+xsun(2).*sinla)./rsun.^2;

demon = -3d0.*dli.*sinphi.*fac2mon.*xmon(3).*(xmon(1).*cosla+xmon(2).*sinla)./rmon.^2;
