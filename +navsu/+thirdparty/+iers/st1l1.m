...
dnsun = -l1./2d0.*sinphi.*cosphi.*fac2sun.*((xsun(1).^2-xsun(2).^2).*costwola+2d0.*xsun(1).*xsun(2).*sintwola)./rsun.^2;

dnmon = -l1./2d0.*sinphi.*cosphi.*fac2mon.*((xmon(1).^2-xmon(2).^2).*costwola+2d0.*xmon(1).*xmon(2).*sintwola)./rmon.^2;

desun = -l1./2d0.*sinphi.^2.*cosphi.*fac2sun.*((xsun(1).^2-xsun(2).^2).*sintwola-2d0.*xsun(1).*xsun(2).*costwola)./rsun.^2;

demon = -l1./2d0.*sinphi.^2.*cosphi.*fac2mon.*((xmon(1).^2-xmon(2).^2).*sintwola-2d0.*xmon(1).*xmon(2).*costwola)./rmon.^2;
